...
import './FORMFROMCODEPEN.css';

class FORMFROMCODEPEN extends React.Component {
    render(){
      return (
        <div className="app-container">
          <div className="row">
            <div className="col">
              <Item name="Instax Mini 90 Neo Classic" price="$144.99" img="httppp://ecx.images-amazon.com/images/I/61%2BABMMN5zL._SL1500_.jpg" />
            </div>
...
export default FORMFROMCODEPEN;