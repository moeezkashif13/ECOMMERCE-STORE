...
let manyCartItems = filteredArray.map(eachElem=>{

    return <CartItems pic={eachElem.pic} price={eachElem.price} totalPriceInitial={eachElem.totalPriceInitial} shoe={eachElem.shoe} size={eachElem.size}/>
